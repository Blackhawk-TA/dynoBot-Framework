...
const DiscordMessage_1 = require("../../src/wrappers/discord/DiscordMessage");
...
describe("The class DiscordMessage", function () {
    beforeEach(function () {
        ...
        this.Message = new DiscordMessage_1.DiscordMessage(this.message);
    });
    afterEach(function () {
        this.message = {};
        this.Message = null;
    ...
    describe("The method getChannel", function () {
        it("Returns the wrapped channel object", function () {
            ...
            //Assert
            assert.strictEqual(Channel instanceof DiscordChannel_1.DiscordChannel, true, "The message object was wrapped.");
        });
    });
    describe("The method getContent", function () {
        it("Returns the message content excluding the first word", function () {
            //Act
            let content = this.Message.getContent(true);
            //Assert
        ...
        it("Returns the message content including the first word", function () {
            //Act
            let content = this.Message.getContent();
            //Assert
    ...
    describe("The method getContentArray", function () {
        it("Returns the message content as array excluding the first word", function () {
            //Act
            let contentArray = this.Message.getContentArray(true);
            //Assert
        ...
        it("Returns the message content as array including the first word", function () {
            //Act
            let contentArray = this.Message.getContentArray();
            //Assert
    ...
    describe("The method getRegexGroups", function () {
        ...
        it("Returns an empty array if there is no message content", function () {
            //Arrange
            this.message.content = "";
            //Act
            let regexGroups = this.Message.getRegexGroups(/(do)\s(some)/);
            //Assert
            assert.deepStrictEqual(regexGroups, [], "An empty array is returned");
            //Cleanup
            this.message.content = "@Bot Do some stuff";
        });
    });
    describe("The method getAuthor", function () {
        it("Returns the wrapped author object", function () {
            ...
            //Assert
            assert.strictEqual(Author instanceof DiscordUser_1.DiscordUser, true, "The author object was wrapped correctly.");
        });
    });
    describe("The method getAuthorRoles", function () {
        it("Returns an array of wrapped role objects", function () {
            ...
            assert.strictEqual(Roles[0] instanceof DiscordRole_1.DiscordRole, true, "The first roles was wrapped correctly.");
            assert.strictEqual(Roles[1] instanceof DiscordRole_1.DiscordRole, true, "The second roles was wrapped correctly.");
        });
    ...
    describe("The method hasServer", function () {
        it("Returns true because the message object has a server object", function () {
            //Act
            let hasServer = this.Message.hasServer();
            //Assert
    ...
    describe("The method isMentioned", function () {
        it("Returns true because the user was mentioned", function () {
            ...
            let User = new DiscordUser_1.DiscordUser(user);
            //Act
            let isMentioned = this.Message.isMentioned(User);
            //Assert
    ...
    describe("The method isDeletable", function () {
        it("Returns the deletable property of the message object", function () {
            //Act
            let isDeletable = this.Message.isDeletable();
            //Assert
    ...
    describe("The method delete", function () {
        it("Deletes the message and returns the wrapped object", function () {
            ...
            return this.Message.delete().then(message => {
                //Assert
                assert.strictEqual(message instanceof DiscordMessage_1.DiscordMessage, true, "The wrapped message object was returned.");
            });
        });
        it("Deletes the message and returns the wrapped object", function () {
            //Arrange
...
//# sourceMappingURL=DiscordMessageTest.js.map