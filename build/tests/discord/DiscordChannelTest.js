...
describe("The class DiscordChannel", function () {
    beforeEach(function () {
        ...
        this.Channel = new DiscordChannel_1.DiscordChannel(this.channel);
    });
    afterEach(function () {
        this.channel = {};
        this.Channel = null;
    ...
    describe("The method getId", function () {
        it("Returns the channel id", function () {
            //Act
            let channelId = this.Channel.getId();
            //Assert
    ...
    describe("The method getName", function () {
        it("Returns the channel name", function () {
            //Act
            let channelName = this.Channel.getName();
            //Assert
    ...
    describe("The method getMessages", function () {
        it("Returns the requested messages", function () {
            ...
            return this.Channel.getMessages(2).then(messages => {
                ...
                assert.strictEqual(messages[0] instanceof DiscordMessage_1.DiscordMessage, true, "The first message object was wrapped correctly.");
                assert.strictEqual(messages[1] instanceof DiscordMessage_1.DiscordMessage, true, "The second message object was wrapped correctly.");
            });
        });
    ...
    describe("The method deleteMessages", function () {
        it("Returns the deleted messages", function () {
            //Arrange
            let FirstMessage = new DiscordMessage_1.DiscordMessage({});
            let SecondMessage = new DiscordMessage_1.DiscordMessage({});
        ...
        it("Returns an error because the delete promise of a message was rejected", function () {
            //Arrange
            let Message = new DiscordMessage_1.DiscordMessage({});
...
//# sourceMappingURL=DiscordChannelTest.js.map